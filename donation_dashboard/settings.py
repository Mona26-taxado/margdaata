...
SECRET_KEY = 'django-insecure-b!htcm#y^!igc!_7+y*qpeg&dwqmp0rrrg#y6c5l%@-c@-9a*m'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'margdaata',  # Make sure this matches your database name
        'USER': 'margdaata',  # Your MySQL username
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Adjust path based on your directory
]
